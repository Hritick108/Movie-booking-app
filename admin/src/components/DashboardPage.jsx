...
const DashboardPage = () => {
    ...
    async function fetchAll() {
      try {
        ...
        const [mRes, bRes, uRes] = await Promise.allSettled([
          ...
          axios.get(`${API_BASE}/api/users`), // not for the user route but to get the user from the bookings done ie one user can have multi booking
        ]);
  ...
  }, []); // this funciton fetches the number and booking relatedt things from the backend.
    ...
    >
      <div className={styles3.maxWidthContainer}>
        ...
        <section className={styles3.summaryGrid}>
          <div className={styles3.summaryCard}>
            <div className={styles3.summaryCardInner}>
              <div>
                <div className={styles3.seatsLabel}> Total Bookings</div>
                <div className={styles3.maxWidthContainer}>
          ...
          <div className={styles3.summaryCard}>
            <div className={styles3.summaryCardInner}>
              <div>
                <div className={styles3.seatsLabel}> Total Revenue</div>
                <div className={styles3.maxWidthContainer}>
            ...
            <div className={styles3.summaryNote}> Paid Bookings Sumed</div>
          </div>

          <div className={styles3.summaryCard}>
            <div className={styles3.summaryCardInner}>
              <div>
                <div className={styles3.seatsLabel}> Total Users</div>
                <div className={styles3.maxWidthContainer}>
                  {summary.totalUsers}
                </div>
              </div>
        ...
        <section className={styles3.moviesSection}>
          ...
          {/* movie / tablet view */}
          <div className={styles3.mobileList}></div>
          {summary.movieStats.map((m) => {
                ...
                <div className={styles3.mobileCardInner}>
                  <div>
                    ...
                    <div className={styles3.mobileLabel}>
                      Bookings:{" "}
                      <span className={styles3.mobileValue}>{m.bookings}</span>
                    </div>
                  </div>
