...
export async function getMovies(req,res) {
    ...
    const total = await Movie.countDocuments(filter);// total numbers of movies
...
export async function deleteMovie(req,res) {
    try {
        ...
        if(m.poster && m.latestTrailer.thumbnail) tryUnlinkUploadUrl(m.latestTrailer.thumbnail); 
...
export default {createMovie,  getMovies, getMoviesById, deleteMovie};